...
{
    public abstract class MyABPPractiseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyABPPractiseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyABPPractiseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyABPPractiseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyABPPractiseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyABPPractiseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyABPPractiseDbContext, Task<T>> func)
        {
            T result;
